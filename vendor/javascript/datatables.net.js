...
/**
	 ...
	 *  @default alert
	 */
errMode:"alert",escape:{attributes:false},feature:[],features:{},
/**
	 * Row searching.
	 * 
 ...
 * @ignore
 */var A=function(e){if(Array.from&&Set)return Array.from(new Set(e));if(I(e))return e.slice();var t,r,a,n=[],i=e.length,o=0;e:for(r=0;r<i;r++){t=e[r];for(a=0;a<o;a++)if(n[a]===t)continue e;n.push(t);o++}return n};var L=function(e,t){if(Array.isArray(t))for(var r=0;r<t.length;r++)L(e,t[r]);else e.push(t);return e};function N(e,t){t&&t.split(" ").forEach((function(t){t&&e.classList.add(t)}))}r.util={
/**
 ...
 */function ce(e,t,r,a){var n=e.aoData[t];var i,o;n._aSortData=null;n._aFilterData=null;n.displayData=null;if(r!=="dom"&&(r&&r!=="auto"||n.src!=="dom")){var l=n.anCells;var s=de(e,t);if(l)if(a!==void 0)re(l[a],s[a]);else for(i=0,o=l.length;i<o;i++)re(l[i],s[i])}else n._aData=fe(e,n,a,a===void 0?void 0:n._aData).data;var u=e.aoColumns;if(a!==void 0){u[a].sType=null;u[a].wideStrings=null}else{for(i=0,o=u.length;i<o;i++){u[i].sType=null;u[i].wideStrings=null}he(e,n)}}
/**
 ...
 *  @memberof DataTable#oApi
 */function he(e,r){var a=r.nTr;var n=r._aData;if(a){var i=e.rowIdFn(n);i&&(a.id=i);if(n.DT_RowClass){var o=n.DT_RowClass.split(" ");r.__rowc=r.__rowc?A(r.__rowc.concat(o)):o;t(a).removeClass(r.__rowc.join(" ")).addClass(n.DT_RowClass)}n.DT_RowAttr&&t(a).attr(n.DT_RowAttr);n.DT_RowData&&t(a).data(n.DT_RowData)}}
/**
 ...
 */function ge(e,r,a){var n,i,o;var l=[];var s=[];var u=e.aoColumns;var c=u.length;var f,d;if(r){a||(a=x(c).filter((function(e){return u[e].bVisible})));for(n=0;n<r.length;n++){l[n]=r[n].slice().filter((function(e,t){return a.includes(t)}));s.push([])}for(n=0;n<l.length;n++)for(i=0;i<l[n].length;i++){f=1;d=1;if(s[n][i]===void 0){o=l[n][i].cell;while(l[n+f]!==void 0&&l[n][i].cell==l[n+f][i].cell){s[n+f][i]=null;f++}while(l[n][i+d]!==void 0&&l[n][i].cell==l[n][i+d].cell){for(var v=0;v<f;v++)s[n+v][i+d]=null;d++}var h=t(".dt-column-title",o);s[n][i]={cell:o,colspan:d,rowspan:f,title:h.length?h.html():t(o).html()}}}return s}}
/**
 ...
 *  @memberof DataTable#oApi
 */function Ie(e,r,a){var n=e.aoColumns;var i=t(r).children("tr");var o,l;var s,u,c,f,d,v,h,p;var g=e.titleRow;var m=r&&r.nodeName.toLowerCase()==="thead";var b=[];var y;var D=function(e,t,r){var a=e[t];while(a[r])r++;return r};for(s=0,f=i.length;s<f;s++)b.push([]);for(s=0,f=i.length;s<f;s++){o=i[s];v=0;l=o.firstChild;while(l){if(l.nodeName.toUpperCase()=="TD"||l.nodeName.toUpperCase()=="TH"){var w=[];var x=t(l);h=l.getAttribute("colspan")*1;p=l.getAttribute("rowspan")*1;h=h&&h!==0&&h!==1?h:1;p=p&&p!==0&&p!==1?p:1;d=D(b,s,v);y=h===1;if(a){if(y){M(e,d,It(x.data()));var S=n[d];var _=l.getAttribute("width")||null;var C=l.style.width.match(/width:\s*(\d+[pxem%]+)/);C&&(_=C[1]);S.sWidthOrig=S.sWidth||_;if(m){S.sTitle===null||S.autoTitle||(g===true&&s===0||g===false&&s===i.length-1||g===s||g===null)&&(l.innerHTML=S.sTitle);if(!S.sTitle&&y){S.sTitle=T(l.innerHTML);S.autoTitle=true}}else S.footer&&(l.innerHTML=S.footer);S.ariaTitle||(S.ariaTitle=x.attr("aria-label")||S.sTitle);S.className&&x.addClass(S.className)}t(".dt-column-title",l).length===0&&t(document.createElement(e.columnTitleTag)).addClass("dt-column-title").append(l.childNodes).appendTo(l);e.orderIndicators&&m&&x.filter(":not([data-dt-order=disable])").length!==0&&x.parent(":not([data-dt-order=disable])").length!==0&&t(".dt-column-order",l).length===0&&t(document.createElement(e.columnTitleTag)).addClass("dt-column-order").appendTo(l);var I=m?"header":"footer";t("div.dt-column-"+I,l).length===0&&t("<div>").addClass("dt-column-"+I).append(l.childNodes).appendTo(l)}for(c=0;c<h;c++){for(u=0;u<p;u++){b[s+u][d+c]={cell:l,unique:y};b[s+u].row=o}w.push(d+c)}l.setAttribute("data-dt-column",A(w).join(","))}l=l.nextSibling}}return b}
/**
 * Set the start position for draw
 *  @param {object} oSettings dataTables settings object
 */function Ae(e){var t=St(e)=="ssp";var r=e.iInitDisplayStart;if(r!==void 0&&r!==-1){e._iDisplayStart=t?r:r>=e.fnRecordsDisplay()?0:r;e.iInitDisplayStart=-1}}
/**
 ...
 */function Le(e,r,a){var n;var i=e.ajax;var o=e.oInstance;var l=function(t){var r=e.jqXHR?e.jqXHR.status:null;if(t===null||typeof r==="number"&&r==204){t={};Re(e,t,[])}var n=t.error||t.sError;n&&pt(e,0,n);if(t.d&&typeof t.d==="string")try{t=JSON.parse(t.d)}catch(e){}e.json=t;Dt(e,null,"xhr",[e,t,e.jqXHR],true);a(t)};if(t.isPlainObject(i)&&i.data){n=i.data;var s=typeof n==="function"?n(r,e):n;r=typeof n==="function"&&s?s:t.extend(true,r,s);delete i.data}var u={url:typeof i==="string"?i:"",data:r,success:l,dataType:"json",cache:false,type:e.sServerMethod,error:function(t,r){var a=Dt(e,null,"xhr",[e,null,e.jqXHR],true);a.indexOf(true)===-1&&(r=="parsererror"?pt(e,0,"Invalid JSON response",1):t.readyState===4&&pt(e,0,"Ajax error",7));Ye(e,false)}};t.isPlainObject(i)&&t.extend(u,i);e.oAjaxData=r;Dt(e,null,"preXhr",[e,r,u],true);if(u.submitAs==="json"&&typeof r==="object"){u.data=JSON.stringify(r);u.contentType||(u.contentType="application/json; charset=utf-8")}if(typeof i==="function")e.jqXHR=i.call(o,r,l,e);else if(i.url===""){var c={};Re(e,c,[]);l(c)}else e.jqXHR=t.ajax(u);n&&(i.data=n)}
/**
 * Update the table using an Ajax call
 *  @param {object} settings dataTables settings object
 *  @returns {boolean} Block the table drawing or not
 *  @memberof DataTable#oApi
 */function Ne(e){e.iDraw++;Ye(e,true);Le(e,Fe(e),(function(t){Oe(e,t)}))}
/**
 ...
 *  @memberof DataTable#oApi
 */function Fe(e){var t=e.aoColumns,r=e.oFeatures,a=e.oPreviousSearch,n=e.aoPreSearchCols,i=function(e,r){return typeof t[e][r]==="function"?"function":t[e][r]};return{draw:e.iDraw,columns:t.map((function(e,t){return{data:i(t,"mData"),name:e.sName,searchable:e.bSearchable,orderable:e.bSortable,search:{value:n[t].search,regex:n[t].regex,fixed:Object.keys(e.searchFixed).map((function(t){return{name:t,term:typeof e.searchFixed[t]!=="function"?e.searchFixed[t].toString():"function"}}))}}})),order:lt(e).map((function(e){return{column:e.col,dir:e.dir,name:i(e.col,"sName")}})),start:e._iDisplayStart,length:r.bPaginate?e._iDisplayLength:-1,search:{value:a.search,regex:a.regex,fixed:Object.keys(e.searchFixed).map((function(t){return{name:t,term:typeof e.searchFixed[t]!=="function"?e.searchFixed[t].toString():"function"}}))}}}
/**
 ...
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function Be(e){var r;var a=e.oInit;var n=e.deferLoading;var i=St(e);if(e.bInitialised){pe(e,"header");pe(e,"footer");vt(e,a,(function(){me(e,e.aoHeader);me(e,e.aoFooter);var o=e.iInitDisplayStart;if(a.aaData)for(r=0;r<a.aaData.length;r++)K(e,a.aaData[r]);else(n||i=="dom")&&Q(e,t(e.nTBody).children("tr"));e.aiDisplay=e.aiDisplayMaster.slice();_e(e);at(e);rt(e);Ye(e,true);Dt(e,null,"preInit",[e],true);ye(e);if(i!="ssp"||n)if(i=="ajax")Le(e,{},(function(t){var a=Re(e,t);for(r=0;r<a.length;r++)K(e,a[r]);e.iInitDisplayStart=o;ye(e);Ye(e,false);qe(e)}),e);else{qe(e);Ye(e,false)}}))}else setTimeout((function(){Be(e)}),200)}
/**
 * Draw the table for the first time, adding all required features
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 ...
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function Ze(e){var r,a,n=e.oScroll,i=n.iBarWidth,o=t(e.nScrollHead),l=o.children("div"),s=l.children("table"),u=e.nScrollBody,c=t(u),f=t(e.nScrollFoot),d=f.children("div"),v=d.children("table"),h=t(e.nTHead),p=t(e.nTable),g=e.nTFoot&&t("th, td",e.nTFoot).length?t(e.nTFoot):null,m=e.oBrowser;var b=u.scrollHeight>u.clientHeight;if(e.scrollBarVis===b||e.scrollBarVis===void 0){e.scrollBarVis=b;p.children("thead, tfoot").remove();r=h.clone().prependTo(p);r.find("th, td").removeAttr("tabindex");r.find("[id]").removeAttr("id");if(g){a=g.clone().prependTo(p);a.find("[id]").removeAttr("id")}if(e.aiDisplay.length){var y=null;var D=St(e)!=="ssp"?e._iDisplayStart:0;for(T=D;T<D+e.aiDisplay.length;T++){var w=e.aiDisplay[T];var x=e.aoData[w].nTr;if(x){y=x;break}}if(y){var S=t(y).children("th, td").map((function(r){return{idx:X(e,r),width:t(this).outerWidth()}}));for(var T=0;T<S.length;T++){var _=e.aoColumns[S[T].idx].colEl[0];var C=_.style.width.replace("px","");if(C!==S[T].width){_.style.width=S[T].width+"px";n.sX&&(_.style.minWidth=S[T].width+"px")}}}}s.find("colgroup").remove();s.append(e.colgroup.clone());if(g){v.find("colgroup").remove();v.append(e.colgroup.clone())}t("th, td",r).each((function(){t(this.childNodes).wrapAll('<div class="dt-scroll-sizing">')}));g&&t("th, td",a).each((function(){t(this.childNodes).wrapAll('<div class="dt-scroll-sizing">')}));var I=Math.floor(p.height())>u.clientHeight||c.css("overflow-y")=="scroll";var A="padding"+(m.bScrollbarLeft?"Left":"Right");var L=p.outerWidth();s.css("width",tt(L));l.css("width",tt(L)).css(A,I?i+"px":"0px");if(g){v.css("width",tt(L));d.css("width",tt(L)).css(A,I?i+"px":"0px")}p.children("colgroup").prependTo(p);c.trigger("scroll");!e.bSorted&&!e.bFiltered||e._drawHold||(u.scrollTop=0)}else{e.scrollBarVis=b;H(e)}}
/**
 * Calculate the width of columns for the table
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function Ke(e){if(e.oFeatures.bAutoWidth){var n,i,o,l,s=e.nTable,u=e.aoColumns,c=e.oScroll,f=c.sY,d=c.sX,v=c.sXInner,h=q(e,"bVisible"),p=s.getAttribute("width"),g=s.parentNode;var m=s.style.width;var b=Qe(e);if(b===e.containerWidth)return false;e.containerWidth=b;if(!m&&!p){s.style.width="100%";m="100%"}m&&m.indexOf("%")!==-1&&(p=m);Dt(e,null,"column-calc",{visible:h},false);var y=t(s.cloneNode()).css("visibility","hidden").css("margin",0).removeAttr("id");y.append("<tbody/>");y.append(t(e.nTHead).clone()).append(t(e.nTFoot).clone());y.find("tfoot th, tfoot td").css("width","");y.find("thead th, thead td").each((function(){var r=J(e,this,true,false);if(r){this.style.width=r;if(d){this.style.minWidth=r;t(this).append(t("<div/>").css({width:r,margin:0,padding:0,border:0,height:1}))}}else this.style.width=""}));var D=[];for(n=0;n<h.length;n++)D.push(et(e,h[n]));if(D.length)for(n=0;n<D[0].length;n++){var w=t("<tr/>").appendTo(y.find("tbody"));for(i=0;i<h.length;i++){l=h[i];o=u[l];var x=D[i][n]||"";var S=a.type.className[o.sType];var T=o.sContentPadding||(d?"-":"");var _=x+T;var C=x.indexOf("<")===-1&&x.indexOf("&")===-1?document.createTextNode(_):_;t("<td/>").addClass(S).addClass(o.sClass).append(C).appendTo(w)}}t("[name]",y).removeAttr("name");var I=t("<div/>").css(d||f?{position:"absolute",top:0,left:0,height:1,right:0,overflow:"hidden"}:{}).append(y).appendTo(g);if(d&&v)y.width(v);else if(d){y.css("width","auto");y.removeAttr("width");y.outerWidth()<g.clientWidth&&p&&y.outerWidth(g.clientWidth)}else f?y.outerWidth(g.clientWidth):p&&y.outerWidth(p);var A=0;var L=y.find("tbody tr").eq(0).children();for(n=0;n<h.length;n++){var N=L[n].getBoundingClientRect().width;A+=N;u[h[n]].sWidth=tt(N)}s.style.width=tt(A);I.remove();p&&(s.style.width=tt(p));if((p||d)&&!e._reszEvt){var F=r.util.throttle((function(){var t=Qe(e);e.bDestroying||t===0||H(e)}));if(window.ResizeObserver){var O=t(e.nTableWrapper).is(":visible");var R=t("<div>").css({width:"100%",height:0}).addClass("dt-autosize").appendTo(e.nTableWrapper);e.resizeObserver=new ResizeObserver((function(e){O?O=false:F()}));e.resizeObserver.observe(R[0])}else t(window).on("resize.DT-"+e.sInstance,F);e._reszEvt=true}}}
/**
 ...
 *  @memberof DataTable#oApi
 */function et(e,t){var r=e.aoColumns[t];if(!r.wideStrings){var a=[];var n=[];for(var i=0,o=e.aiDisplayMaster.length;i<o;i++){var l=e.aiDisplayMaster[i];var s=de(e,l)[t];var u=s&&typeof s==="object"&&s.nodeType?s.innerHTML:s+"";u=u.replace(/id=".*?"/g,"").replace(/name=".*?"/g,"");u=u.replace(/<script.*?<\/script>/gi," ");var c=T(u," ").replace(/&nbsp;/g," ");n.push({str:u,len:c.length});a.push(c)}n.sort((function(e,t){return t.len-e.len})).splice(3);r.wideStrings=n.map((function(e){return e.str}));let f=a.join(" ").split(" ");f.sort((function(e,t){return t.length-e.length}));f.length&&r.wideStrings.push(f[0]);f.length>1&&r.wideStrings.push(f[1]);f.length>2&&r.wideStrings.push(f[3])}return r.wideStrings}
/**
 ...
 */function rt(e){var t=e.aoColumns;e.colgroup.empty();for(mr=0;mr<t.length;mr++)t[mr].bVisible&&e.colgroup.append(t[mr].colEl)}function at(e){var t=e.nTHead;var r=t.querySelectorAll("tr");var a=e.titleRow;var n=':not([data-dt-order="disable"]):not([data-dt-order="icon-only"])';a===true?t=r[0]:a===false?t=r[r.length-1]:a!==null&&(t=r[a]);e.orderHandler&&nt(e,t,t===e.nTHead?"tr"+n+" th"+n+", tr"+n+" td"+n:"th"+n+", td"+n);var i=[];ot(e,i,e.aaSorting);e.aaSorting=i}function nt(e,t,r,a,n){bt(t,r,(function(t){var r=false;var i=a===void 0?Z(t.target):typeof a==="function"?a():Array.isArray(a)?a:[a];if(i.length){for(var o=0,l=i.length;o<l;o++){var s=ut(e,i[o],o,t.shiftKey);s!==false&&(r=true);if(e.aaSorting.length===1&&e.aaSorting[0][1]==="")break}r&&Ge(e,true,(function(){st(e);it(e,e.aiDisplay);ye(e,false,false);n&&n()}))}}))}
/**
 ...
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function st(e,t,a){var n,i,o,l,s=[],u=r.ext.type.order,c=e.aoData,f=e.aiDisplayMaster;z(e);if(t!==void 0){var d=e.aoColumns[t];l=[{src:t,col:t,dir:a,index:0,type:d.sType,formatter:u[d.sType+"-pre"],sorter:u[d.sType+"-"+a]}];f=f.slice()}else l=lt(e);for(n=0,i=l.length;n<i;n++){o=l[n];ft(e,o.col)}if(St(e)!="ssp"&&l.length!==0){for(n=0,i=f.length;n<i;n++)s[n]=n;l.length&&l[0].dir==="desc"&&e.orderDescReverse&&s.reverse();f.sort((function(e,t){var r,a,n,i,o,u=l.length,f=c[e]._aSortData,d=c[t]._aSortData;for(n=0;n<u;n++){o=l[n];r=f[o.col];a=d[o.col];if(o.sorter){i=o.sorter(r,a);if(i!==0)return i}else{i=r<a?-1:r>a?1:0;if(i!==0)return o.dir==="asc"?i:-i}}r=s[e];a=s[t];return r<a?-1:r>a?1:0}))}else l.length===0&&f.sort((function(e,t){return e<t?-1:e>t?1:0}));if(t===void 0){e.bSorted=true;e.sortDetails=l;Dt(e,null,"order",[e,l])}return f}
/**
 ...
 *  @memberof DataTable#oApi
 */function ut(e,t,r,a){var n=e.aoColumns[t];var i=e.aaSorting;var o=n.asSorting;var l;var s=function(e,t){var r=e._idx;r===void 0&&(r=o.indexOf(e[1]));return r+1<o.length?r+1:t?null:0};if(!n.bSortable)return false;typeof i[0]==="number"&&(i=e.aaSorting=[i]);if((a||r)&&e.oFeatures.bSortMulti){var u=D(i,"0").indexOf(t);if(u!==-1){l=s(i[u],true);l===null&&i.length===1&&(l=0);if(l===null||o[l]==="")i.splice(u,1);else{i[u][1]=o[l];i[u]._idx=l}}else if(a){i.push([t,o[0],0]);i[i.length-1]._idx=0}else{i.push([t,i[0][1],0]);i[i.length-1]._idx=0}}else if(i.length&&i[0][0]==t){l=s(i[0]);i.length=1;i[0][1]=o[l];i[0]._idx=l}else{i.length=0;i.push([t,o[0]]);i[0]._idx=0}}
/**
 ...
 * @returns 
 */function _t(e,t){if(t)if(t.length<1e4)e.push.apply(e,t);else for(mr=0;mr<t.length;mr++)e.push(t[mr])}
/**
 ...
 */function Ct(e,t,r){Array.isArray(r)||(r=[r]);for(mr=0;mr<r.length;mr++)e.on(t+".dt",r[mr])}function It(e){r.ext.escape.attributes&&t.each(e,(function(t,r){e[t]=_(r)}));return e}
/**
 ...
 * @return {array}
 * @ignore
 */var Rt=function(e,r){if(Array.isArray(e)){var a=[];e.forEach((function(e){var t=Rt(e,r);_t(a,t)}));return a.filter((function(e){return e}))}if(typeof e==="number")return[r[e]];var n=r.map((function(e){return e.nTable}));return t(n).filter(e).map((function(){var e=n.indexOf(this);return r[e]})).toArray()};
/**
 ...
 * @returns {DataTables.Api} this
 */i("page.len()",(function(e){return e===void 0?this.context.length!==0?this.context[0]._iDisplayLength:void 0:this.iterator("table",(function(t){Ue(t,e)}))}));var jt=function(e,t,r){if(r){var a=new n(e);a.one("draw",(function(){r(a.ajax.json())}))}if(St(e)=="ssp")ye(e,t);else{Ye(e,true);var i=e.jqXHR;i&&i.readyState!==4&&i.abort();Le(e,{},(function(r){ue(e);var a=Re(e,r);for(var n=0,i=a.length;n<i;n++)K(e,a[n]);ye(e,t);qe(e);Ye(e,false)}))}};i("ajax.json()",(function(){var e=this.context;if(e.length>0)return e[0].json}));i("ajax.params()",(function(){var e=this.context;if(e.length>0)return e[0].oAjaxData}));
/**
 ...
 * @returns {DataTables.Api} this
 */i("ajax.reload()",(function(e,t){return this.iterator("table",(function(r){jt(r,t===false,e)}))}));
/**
 ...
 *
 * @returns {DataTables.Api} this
 */i("ajax.url().load()",(function(e,t){return this.iterator("table",(function(r){jt(r,t===false,e)}))}));var Pt=function(e,t,r,n,i){var o,l,s,u=[],c=typeof t;t&&c!=="string"&&c!=="function"&&t.length!==void 0||(t=[t]);for(l=0,s=t.length;l<s;l++){o=r(typeof t[l]==="string"?t[l].trim():t[l]);o=o.filter((function(e){return e!==null&&e!==void 0}));o&&o.length&&(u=u.concat(o))}var f=a.selector[e];if(f.length)for(l=0,s=f.length;l<s;l++)u=f[l](n,i,u);return A(u)};var Et=function(e){e||(e={});e.filter&&e.search===void 0&&(e.search=e.filter);return t.extend({columnOrder:"implied",search:"none",order:"current",page:"all"},e)};var kt=function(e){var t=new n(e.context[0]);e.length&&t.push(e[0]);t.selector=e.selector;t.length&&t[0].length>1&&t[0].splice(1);return t};var Mt=function(e,t){var r,a,n,i=[],o=e.aiDisplay,l=e.aiDisplayMaster;var s=t.search,u=t.order,c=t.page;if(St(e)=="ssp")return s==="removed"?[]:x(0,l.length);if(c=="current")for(r=e._iDisplayStart,a=e.fnDisplayEnd();r<a;r++)i.push(o[r]);else if(u=="current"||u=="applied"){if(s=="none")i=l.slice();else if(s=="applied")i=o.slice();else if(s=="removed"){var f={};for(r=0,a=o.length;r<a;r++)f[o[r]]=null;l.forEach((function(e){Object.prototype.hasOwnProperty.call(f,e)||i.push(e)}))}}else if(u=="index"||u=="original"){for(r=0,a=e.aoData.length;r<a;r++)if(e.aoData[r])if(s=="none")i.push(r);else{n=o.indexOf(r);(n===-1&&s=="removed"||n>=0&&s=="applied")&&i.push(r)}}else if(typeof u==="number"){var d=st(e,u,"asc");if(s==="none")i=d;else for(r=0;r<d.length;r++){n=o.indexOf(d[r]);(n===-1&&s=="removed"||n>=0&&s=="applied")&&i.push(d[r])}}return i};var Ht=function(e,r,a){var n;var i=function(r){var i=p(r);var o=e.aoData;if(i!==null&&!a)return[i];n||(n=Mt(e,a));if(i!==null&&n.indexOf(i)!==-1)return[i];if(r===null||r===void 0||r==="")return n;if(typeof r==="function")return n.map((function(e){var t=o[e];return r(e,t._aData,t.nTr)?e:null}));if(r.nodeName){var l=r._DT_RowIndex;var s=r._DT_CellIndex;if(l!==void 0)return o[l]&&o[l].nTr===r?[l]:[];if(s)return o[s.row]&&o[s.row].nTr===r.parentNode?[s.row]:[];var u=t(r).closest("*[data-dt-row]");return u.length?[u.data("dt-row")]:[]}if(typeof r==="string"&&r.charAt(0)==="#"){var c=e.aIds[r.replace(/^#/,"")];if(c!==void 0)return[c.idx]}var f=S(w(e.aoData,n,"nTr"));return t(f).filter(r).map((function(){return this._DT_RowIndex})).toArray()};var o=Pt("row",r,i,e,a);a.order!=="current"&&a.order!=="applied"||it(e,o);return o};i("rows()",(function(e,r){if(e===void 0)e="";else if(t.isPlainObject(e)){r=e;e=""}r=Et(r);var a=this.iterator("table",(function(t){return Ht(t,e,r)}),1);a.selector.rows=e;a.selector.opts=r;return a}));i("rows().nodes()",(function(){return this.iterator("row",(function(e,t){return e.aoData[t].nTr||void 0}),1)}));i("rows().data()",(function(){return this.iterator(true,"rows",(function(e,t){return w(e.aoData,t,"_aData")}),1)}));o("rows().cache()","row().cache()",(function(e){return this.iterator("row",(function(t,r){var a=t.aoData[r];return e==="search"?a._aFilterData:a._aSortData}),1)}));o("rows().invalidate()","row().invalidate()",(function(e){return this.iterator("row",(function(t,r){ce(t,r,e)}))}));o("rows().indexes()","row().index()",(function(){return this.iterator("row",(function(e,t){return t}),1)}));o("rows().ids()","row().id()",(function(e){var t=[];var r=this.context;for(var a=0,i=r.length;a<i;a++)for(var o=0,l=this[a].length;o<l;o++){var s=r[a].rowIdFn(r[a].aoData[this[a][o]]._aData);t.push((e===true?"#":"")+s)}return new n(r,t)}));o("rows().remove()","row().remove()",(function(){this.iterator("row",(function(e,t){var r=e.aoData;var a=r[t];var n=e.aiDisplayMaster.indexOf(t);n!==-1&&e.aiDisplayMaster.splice(n,1);e._iRecordsDisplay>0&&e._iRecordsDisplay--;wt(e);var i=e.rowIdFn(a._aData);i!==void 0&&delete e.aIds[i];r[t]=null}));return this}));i("rows.add()",(function(e){var t=this.iterator("table",(function(t){var r,a,n;var i=[];for(a=0,n=e.length;a<n;a++){r=e[a];r.nodeName&&r.nodeName.toUpperCase()==="TR"?i.push(Q(t,r)[0]):i.push(K(t,r))}return i}),1);var r=this.rows(-1);r.pop();_t(r,t);return r}));i("row()",(function(e,t){return kt(this.rows(e,t))}));i("row().data()",(function(e){var t=this.context;if(e===void 0)return t.length&&this.length&&this[0].length?t[0].aoData[this[0]]._aData:void 0;var r=t[0].aoData[this[0]];r._aData=e;Array.isArray(e)&&r.nTr&&r.nTr.id&&le(t[0].rowId)(e,r.nTr.id);ce(t[0],this[0],"data");return this}));i("row().node()",(function(){var e=this.context;if(e.length&&this.length&&this[0].length){var t=e[0].aoData[this[0]];if(t&&t.nTr)return t.nTr}return null}));i("row.add()",(function(e){e instanceof t&&e.length&&(e=e[0]);var r=this.iterator("table",(function(t){return e.nodeName&&e.nodeName.toUpperCase()==="TR"?Q(t,e)[0]:K(t,e)}));return this.row(r[0])}));t(document).on("plugin-init.dt",(function(e,t){var r=new n(t);r.on("stateSaveParams.DT",(function(e,t,r){var a=t.rowIdFn;var n=t.aiDisplayMaster;var i=[];for(var o=0;o<n.length;o++){var l=n[o];var s=t.aoData[l];s._detailsShow&&i.push("#"+a(s._aData))}r.childRows=i}));r.on("stateLoaded.DT",(function(e,t,a){Wt(r,a)}));Wt(r,r.state.loaded())}));var Wt=function(e,t){t&&t.childRows&&e.rows(t.childRows.map((function(e){return e.replace(/([^:\\]*(?:\\.[^:\\]*)*):/g,"$1\\:")}))).every((function(){Dt(e.settings()[0],null,"requestChild",[this])}))};var Xt=function(e,r,a,n){var i=[];var o=function(a,n){if(Array.isArray(a)||a instanceof t)for(var l=0,s=a.length;l<s;l++)o(a[l],n);else if(a.nodeName&&a.nodeName.toLowerCase()==="tr"){a.setAttribute("data-dt-row",r.idx);i.push(a)}else{var u=t("<tr><td></td></tr>").attr("data-dt-row",r.idx).addClass(n);t("td",u).addClass(n).html(a)[0].colSpan=B(e);i.push(u[0])}};o(a,n);r._details&&r._details.detach();r._details=t(i);r._detailsShow&&r._details.insertAfter(r.nTr)};var Vt=r.util.throttle((function(e){dt(e[0])}),500);var Bt=function(e,r){var a=e.context;if(a.length){var n=a[0].aoData[r!==void 0?r:e[0]];if(n&&n._details){n._details.detach();n._detailsShow=void 0;n._details=void 0;t(n.nTr).removeClass("dt-hasChild");Vt(a)}}};var qt=function(e,r){var a=e.context;if(a.length&&e.length){var n=a[0].aoData[e[0]];if(n._details){n._detailsShow=r;if(r){n._details.insertAfter(n.nTr);t(n.nTr).addClass("dt-hasChild")}else{n._details.detach();t(n.nTr).removeClass("dt-hasChild")}Dt(a[0],null,"childRow",[r,e.row(e[0])]);Ut(a[0]);Vt(a)}}};var Ut=function(e){var r=new n(e);var a=".dt.DT_details";var i="draw"+a;var o="column-sizing"+a;var l="destroy"+a;var s=e.aoData;r.off(i+" "+o+" "+l);if(D(s,"_details").length>0){r.on(i,(function(t,a){e===a&&r.rows({page:"current"}).eq(0).each((function(e){var t=s[e];t._detailsShow&&t._details.insertAfter(t.nTr)}))}));r.on(o,(function(r,a){if(e===a){var n,i=B(a);for(var o=0,l=s.length;o<l;o++){n=s[o];n&&n._details&&n._details.each((function(){var e=t(this).children("td");e.length==1&&e.attr("colspan",i)}))}}}));r.on(l,(function(t,a){if(e===a)for(var n=0,i=s.length;n<i;n++)s[n]&&s[n]._details&&Bt(r,n)}))}};var zt="";var $t=zt+"row().child";var Yt=$t+"()";i(Yt,(function(e,t){var r=this.context;if(e===void 0)return r.length&&this.length&&r[0].aoData[this[0]]?r[0].aoData[this[0]]._details:void 0;e===true?this.child.show():e===false?Bt(this):r.length&&this.length&&Xt(r[0],r[0].aoData[this[0]],e,t);return this}));i([$t+".show()",Yt+".show()"],(function(){qt(this,true);return this}));i([$t+".hide()",Yt+".hide()"],(function(){qt(this,false);return this}));i([$t+".remove()",Yt+".remove()"],(function(){Bt(this);return this}));i($t+".isShown()",(function(){var e=this.context;return e.length&&this.length&&e[0].aoData[this[0]]&&e[0].aoData[this[0]]._detailsShow||false}));var Gt=/^([^:]+)?:(name|title|visIdx|visible)$/;var Jt=function(e,t,r,a,n,i){var o=[];for(var l=0,s=n.length;l<s;l++)o.push(ee(e,n[l],t,i));return o};var Zt=function(e,r,a){var n=e.aoHeader;var i=e.titleRow;var o=null;if(a!==void 0)o=a;else if(i===true)o=0;else if(i===false)o=n.length-1;else if(i!==null)o=i;else{for(var l=0;l<n.length;l++)n[l][r].unique&&t(".dt-column-title",n[l][r].cell).text()&&(o=l);o===null&&(o=0)}return n[o][r].cell};var Kt=function(e){var t=[];for(var r=0;r<e.length;r++)for(var a=0;a<e[r].length;a++){var n=e[r][a].cell;t.includes(n)||t.push(n)}return t};var Qt=function(e,r,a){var n,i,o=e.aoColumns,l=Kt(e.aoHeader);var s=function(r){var s=p(r);if(r==="")return x(o.length);if(s!==null)return[s>=0?s:o.length+s];if(typeof r==="function"){var u=Mt(e,a);return o.map((function(t,a){return r(a,Jt(e,a,0,0,u),Zt(e,a))?a:null}))}var c=typeof r==="string"?r.match(Gt):"";if(c)switch(c[2]){case"visIdx":case"visible":if(c[1]&&c[1].match(/^\d+$/)){var f=parseInt(c[1],10);if(f<0){var d=o.map((function(e,t){return e.bVisible?t:null}));return[d[d.length+f]]}return[X(e,f)]}return o.map((function(e,r){return e.bVisible?c[1]?t(l[r]).filter(c[1]).length>0?r:null:r:null}));case"name":n||(n=D(o,"sName"));return n.map((function(e,t){return e===c[1]?t:null}));case"title":i||(i=D(o,"sTitle"));return i.map((function(e,t){return e===c[1]?t:null}));default:return[]}if(r.nodeName&&r._DT_CellIndex)return[r._DT_CellIndex.column];var v=t(l).filter(r).map((function(){return Z(this)})).toArray().sort((function(e,t){return e-t}));if(v.length||!r.nodeName)return v;var h=t(r).closest("*[data-dt-column]");return h.length?[h.data("dt-column")]:[]};var u=Pt("column",r,s,e,a);return a.columnOrder&&a.columnOrder==="index"?u.sort((function(e,t){return e-t})):u};var er=function(e,r,a){var n,i,o,l,s=e.aoColumns,u=s[r],c=e.aoData;if(a===void 0)return u.bVisible;if(u.bVisible===a)return false;if(a){var f=D(s,"bVisible").indexOf(true,r+1);for(i=0,o=c.length;i<o;i++)if(c[i]){l=c[i].nTr;n=c[i].anCells;l&&l.insertBefore(n[r],n[f]||null)}}else t(D(e.aoData,"anCells",r)).detach();u.bVisible=a;rt(e);return true};i("columns()",(function(e,r){if(e===void 0)e="";else if(t.isPlainObject(e)){r=e;e=""}r=Et(r);var a=this.iterator("table",(function(t){return Qt(t,e,r)}),1);a.selector.cols=e;a.selector.opts=r;return a}));o("columns().header()","column().header()",(function(e){return this.iterator("column",(function(t,r){return Zt(t,r,e)}),1)}));o("columns().footer()","column().footer()",(function(e){return this.iterator("column",(function(t,r){var a=t.aoFooter;return a.length?t.aoFooter[e!==void 0?e:0][r].cell:null}),1)}));o("columns().data()","column().data()",(function(){return this.iterator("column-rows",Jt,1)}));o("columns().render()","column().render()",(function(e){return this.iterator("column-rows",(function(t,r,a,n,i){return Jt(t,r,a,n,i,e)}),1)}));o("columns().dataSrc()","column().dataSrc()",(function(){return this.iterator("column",(function(e,t){return e.aoColumns[t].mData}),1)}));o("columns().cache()","column().cache()",(function(e){return this.iterator("column-rows",(function(t,r,a,n,i){return w(t.aoData,i,e==="search"?"_aFilterData":"_aSortData",r)}),1)}));o("columns().init()","column().init()",(function(){return this.iterator("column",(function(e,t){return e.aoColumns[t]}),1)}));o("columns().names()","column().name()",(function(){return this.iterator("column",(function(e,t){return e.aoColumns[t].sName}),1)}));o("columns().nodes()","column().nodes()",(function(){return this.iterator("column-rows",(function(e,t,r,a,n){return w(e.aoData,n,"anCells",t)}),1)}));o("columns().titles()","column().title()",(function(e,r){return this.iterator("column",(function(a,n){if(typeof e==="number"){r=e;e=void 0}var i=t(".dt-column-title",this.column(n).header(r));if(e!==void 0){i.html(e);return this}return i.html()}),1)}));o("columns().types()","column().type()",(function(){return this.iterator("column",(function(e,t){var r=e.aoColumns[t];var a=r.sType;if(!a){z(e);a=r.sType}return a}),1)}));o("columns().visible()","column().visible()",(function(e,r){var a=this;var n=[];var i=this.iterator("column",(function(t,r){if(e===void 0)return t.aoColumns[r].bVisible;er(t,r,e)&&n.push(r)}));e!==void 0&&this.iterator("table",(function(i){me(i,i.aoHeader);me(i,i.aoFooter);i.aiDisplay.length||t(i.nTBody).find("td[colspan]").attr("colspan",B(i));dt(i);a.iterator("column",(function(t,a){n.includes(a)&&Dt(t,null,"column-visibility",[t,a,e,r])}));n.length&&(r===void 0||r)&&a.columns.adjust()}));return i}));o("columns().widths()","column().width()",(function(){var e=this.columns(":visible").count();var r=t("<tr>").html("<td>"+Array(e).join("</td><td>")+"</td>");t(this.table().body()).append(r);var a=r.children().map((function(){return t(this).outerWidth()}));r.remove();return this.iterator("column",(function(e,t){var r=V(e,t);return r!==null?a[r]:0}),1)}));o("columns().indexes()","column().index()",(function(e){return this.iterator("column",(function(t,r){return e==="visible"?V(t,r):r}),1)}));i("columns.adjust()",(function(){return this.iterator("table",(function(e){e.containerWidth=-1;H(e)}),1)}));i("column.index()",(function(e,t){if(this.context.length!==0){var r=this.context[0];if(e==="fromVisible"||e==="toData")return X(r,t);if(e==="fromData"||e==="toVisible")return V(r,t)}}));i("column()",(function(e,t){return kt(this.columns(e,t))}));var tr=function(e,r,a){var n=e.aoData;var i=Mt(e,a);var o=S(w(n,i,"anCells"));var l=t(L([],o));var s;var u=e.aoColumns.length;var c,f,d,v,h,p;var g=function(r){var a=typeof r==="function";if(r===null||r===void 0||a){c=[];for(f=0,d=i.length;f<d;f++){s=i[f];for(v=0;v<u;v++){h={row:s,column:v};if(a){p=n[s];r(h,ee(e,s,v),p.anCells?p.anCells[v]:null)&&c.push(h)}else c.push(h)}}return c}if(t.isPlainObject(r))return r.column!==void 0&&r.row!==void 0&&i.indexOf(r.row)!==-1?[r]:[];var o=l.filter(r).map((function(e,t){return{row:t._DT_CellIndex.row,column:t._DT_CellIndex.column}})).toArray();if(o.length||!r.nodeName)return o;p=t(r).closest("*[data-dt-row]");return p.length?[{row:p.data("dt-row"),column:p.data("dt-column")}]:[]};return Pt("cell",r,g,e,a)};i("cells()",(function(e,r,a){if(t.isPlainObject(e))if(e.row===void 0){a=e;e=null}else{a=r;r=null}if(t.isPlainObject(r)){a=r;r=null}if(r===null||r===void 0)return this.iterator("table",(function(t){return tr(t,e,Et(a))}));var n=a?{page:a.page,order:a.order,search:a.search}:{};var i=this.columns(r,n);var o=this.rows(e,n);var l,s,u,c;var f=this.iterator("table",(function(e,t){var r=[];for(l=0,s=o[t].length;l<s;l++)for(u=0,c=i[t].length;u<c;u++)r.push({row:o[t][l],column:i[t][u]});return r}),1);var d=a&&a.selected?this.cells(f,a):f;t.extend(d.selector,{cols:r,rows:e,opts:a});return d}));o("cells().nodes()","cell().node()",(function(){return this.iterator("cell",(function(e,t,r){var a=e.aoData[t];return a&&a.anCells?a.anCells[r]:void 0}),1)}));i("cells().data()",(function(){return this.iterator("cell",(function(e,t,r){return ee(e,t,r)}),1)}));o("cells().cache()","cell().cache()",(function(e){e=e==="search"?"_aFilterData":"_aSortData";return this.iterator("cell",(function(t,r,a){return t.aoData[r][e][a]}),1)}));o("cells().render()","cell().render()",(function(e){return this.iterator("cell",(function(t,r,a){return ee(t,r,a,e)}),1)}));o("cells().indexes()","cell().index()",(function(){return this.iterator("cell",(function(e,t,r){return{row:t,column:r,columnVisible:V(e,r)}}),1)}));o("cells().invalidate()","cell().invalidate()",(function(e){return this.iterator("cell",(function(t,r,a){ce(t,r,e,a)}))}));i("cell()",(function(e,t,r){return kt(this.cells(e,t,r))}));i("cell().data()",(function(e){var t=this.context;var r=this[0];if(e===void 0)return t.length&&r.length?ee(t[0],r[0].row,r[0].column):void 0;te(t[0],r[0].row,r[0].column,e);ce(t[0],r[0].row,"data",r[0].column);return this}));
/**
...
/**
		 ...
		 */
sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},orderDescReverse:true,oSearch:t.extend({},r.models.oSearch),layout:{topStart:"pageLength",topEnd:"search",bottomStart:"info",bottomEnd:"paging"},sDom:null,searchDelay:null,sPaginationType:"",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId",caption:null,iDeferLoading:null,on:null,columnTitleTag:"span"};F(r.defaults);r.defaults.column={aDataSort:null,iDataSort:-1,ariaTitle:"",asSorting:["asc","desc",""],bSearchable:true,bSortable:true,bVisible:true,fnCreatedCell:null,mData:null,mRender:null,sCellType:"td",sClass:"",sContentPadding:"",sDefaultContent:null,sName:"",sSortDataType:"std",sTitle:null,sType:null,sWidth:null};F(r.defaults.column);r.models.oSettings={oFeatures:{bAutoWidth:null,bDeferRender:null,bFilter:null,
/**
		 * Used only for compatibility with DT1
		 * @deprecated
		 */
...
/**
	 ...
	 *  @deprecated
	 */
bSorted:false,bSortCellsTop:null,oInit:null,aoDestroyCallback:[],fnRecordsTotal:function(){return St(this)=="ssp"?this._iRecordsTotal*1:this.aiDisplayMaster.length},fnRecordsDisplay:function(){return St(this)=="ssp"?this._iRecordsDisplay*1:this.aiDisplay.length},fnDisplayEnd:function(){var e=this._iDisplayLength,t=this._iDisplayStart,r=t+e,a=this.aiDisplay.length,n=this.oFeatures,i=n.bPaginate;return n.bServerSide?i===false||e===-1?t+a:Math.min(t+e,this._iRecordsDisplay):!i||r>a||e===-1?a:r},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null,caption:"",captionNode:null,colgroup:null,deferLoading:null,typeDetect:true,resizeObserver:null,containerWidth:-1,orderDescReverse:null,orderIndicators:true,orderHandler:true,titleRow:null,columnTitleTag:"span"};var ir=r.ext.pager;t.extend(ir,{simple:function(){return["previous","next"]},full:function(){return["first","previous","next","last"]},numbers:function(){return["numbers"]},simple_numbers:function(){return["previous","numbers","next"]},full_numbers:function(){return["first","previous","numbers","next","last"]},first_last:function(){return["first","last"]},first_last_numbers:function(){return["first","numbers","last"]},_numbers:Ar,numbers_length:7});t.extend(true,r.ext.renderer,{pagingButton:{_:function(e,r,a,n,i){var o=e.oClasses.paging;var l=[o.button];var s;n&&l.push(o.active);i&&l.push(o.disabled);s=r==="ellipsis"?t('<span class="ellipsis"></span>').html(a)[0]:t("<button>",{class:l.join(" "),role:"link",type:"button"}).html(a);return{display:s,clicker:s}}},pagingContainer:{_:function(e,t){return t}}});var or=function(e,t){return function(r){if(h(r)||typeof r!=="string")return r;r=r.replace(s," ");e&&(r=T(r));t&&(r=C(r,false));return r}};function lr(e,t,r,a,n){return cr?e[t](n):ur?e[r](n):a?e[a](n):e}var sr=false;var ur;var cr;function fr(){window.luxon&&!ur&&(ur=window.luxon);window.moment&&!cr&&(cr=window.moment)}function dr(e,t,r){var a;fr();if(cr){a=cr.utc(e,t,r,true);if(!a.isValid())return null}else if(ur){a=t&&typeof e==="string"?ur.DateTime.fromFormat(e,t):ur.DateTime.fromISO(e);if(!a.isValid)return null;a=a.setLocale(r)}else if(t){sr||alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17");sr=true}else a=new Date(e);return a}function vr(e){return function(t,a,n,i){if(arguments.length===0){n="en";a=null;t=null}else if(arguments.length===1){n="en";a=t;t=null}else if(arguments.length===2){n=a;a=t;t=null}var o="datetime"+(a?"-"+a:"");r.ext.type.order[o+"-pre"]||r.type(o,{detect:function(e){return e===o&&o},order:{pre:function(e){return e.valueOf()}},className:"dt-right"});return function(r,l){if(r===null||r===void 0)if(i==="--now"){var s=new Date;r=new Date(Date.UTC(s.getFullYear(),s.getMonth(),s.getDate(),s.getHours(),s.getMinutes(),s.getSeconds()))}else r="";if(l==="type")return o;if(r==="")return l!=="sort"?"":dr("0000-01-01 00:00:00",null,n);if(a!==null&&t===a&&l!=="sort"&&l!=="type"&&!(r instanceof Date))return r;var u=dr(r,t,n);if(u===null)return r;if(l==="sort")return u;var c=a===null?lr(u,"toDate","toJSDate","")[e](navigator.language,{timeZone:"UTC"}):lr(u,"format","toFormat","toISOString",a);return l==="display"?_(c):c}}}var hr=",";var pr=".";if(window.Intl!==void 0)try{var gr=(new Intl.NumberFormat).formatToParts(100000.1);for(var mr=0;mr<gr.length;mr++)gr[mr].type==="group"?hr=gr[mr].value:gr[mr].type==="decimal"&&(pr=gr[mr].value)}catch(e){}r.datetime=function(e,t){var a="datetime-"+e;t||(t="en");r.ext.type.order[a]||r.type(a,{detect:function(r){var n=dr(r,e,t);return!(r!==""&&!n)&&a},order:{pre:function(r){return dr(r,e,t)||0}},className:"dt-right"})};r.render={date:vr("toLocaleDateString"),datetime:vr("toLocaleString"),time:vr("toLocaleTimeString"),number:function(e,t,r,a,n){e!==null&&e!==void 0||(e=hr);t!==null&&t!==void 0||(t=pr);return{display:function(i){if(typeof i!=="number"&&typeof i!=="string")return i;if(i===""||i===null)return i;var o=i<0?"-":"";var l=parseFloat(i);var s=Math.abs(l);if(s>=1e11||s<1e-4&&s!==0){var u=l.toExponential(r).split(/e\+?/);return u[0]+" x 10<sup>"+u[1]+"</sup>"}if(isNaN(l))return _(i);l=l.toFixed(r);i=Math.abs(l);var c=parseInt(i,10);var f=r?t+(i-c).toFixed(r).substring(2):"";c===0&&parseFloat(f)===0&&(o="");return o+(a||"")+c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,e)+f+(n||"")}}},text:function(){return{display:_,filter:_}}};var br=r.ext.type;r.type=function(e,t,r){if(!t)return{className:br.className[e],detect:br.detect.find((function(t){return t._name===e})),order:{pre:br.order[e+"-pre"],asc:br.order[e+"-asc"],desc:br.order[e+"-desc"]},render:br.render[e],search:br.search[e]};var a=function(t,r){br[t][e]=r};var n=function(t){Object.defineProperty(t,"_name",{value:e});var r=br.detect.findIndex((function(t){return t._name===e}));r===-1?br.detect.unshift(t):br.detect.splice(r,1,t)};var i=function(t){br.order[e+"-pre"]=t.pre;br.order[e+"-asc"]=t.asc;br.order[e+"-desc"]=t.desc};if(r===void 0){r=t;t=null}if(t==="className")a("className",r);else if(t==="detect")n(r);else if(t==="order")i(r);else if(t==="render")a("render",r);else if(t==="search")a("search",r);else if(!t){r.className&&a("className",r.className);r.detect!==void 0&&n(r.detect);r.order&&i(r.order);r.render!==void 0&&a("render",r.render);r.search!==void 0&&a("search",r.search)}};r.types=function(){return br.detect.map((function(e){return e._name}))};var yr=function(e,t){e=e!==null&&e!==void 0?e.toString().toLowerCase():"";t=t!==null&&t!==void 0?t.toString().toLowerCase():"";return e.localeCompare(t,navigator.languages[0]||navigator.language,{numeric:true,ignorePunctuation:true})};var Dr=function(e,t){e=T(e);t=T(t);return yr(e,t)};r.type("string",{detect:function(){return"string"},order:{pre:function(e){return h(e)&&typeof e!=="boolean"?"":typeof e==="string"?e.toLowerCase():e.toString?e.toString():""}},search:or(false,true)});r.type("string-utf8",{detect:{allOf:function(e){return true},oneOf:function(e){return!h(e)&&navigator.languages&&typeof e==="string"&&e.match(/[^\x00-\x7F]/)}},order:{asc:yr,desc:function(e,t){return yr(e,t)*-1}},search:or(false,true)});r.type("html",{detect:{allOf:function(e){return h(e)||typeof e==="string"&&e.indexOf("<")!==-1},oneOf:function(e){return!h(e)&&typeof e==="string"&&e.indexOf("<")!==-1}},order:{pre:function(e){return h(e)?"":e.replace?T(e).trim().toLowerCase():e+""}},search:or(true,true)});r.type("html-utf8",{detect:{allOf:function(e){return h(e)||typeof e==="string"&&e.indexOf("<")!==-1},oneOf:function(e){return navigator.languages&&!h(e)&&typeof e==="string"&&e.indexOf("<")!==-1&&typeof e==="string"&&e.match(/[^\x00-\x7F]/)}},order:{asc:Dr,desc:function(e,t){return Dr(e,t)*-1}},search:or(true,true)});r.type("date",{className:"dt-type-date",detect:{allOf:function(e){if(e&&!(e instanceof Date)&&!f.test(e))return null;var t=Date.parse(e);return t!==null&&!isNaN(t)||h(e)},oneOf:function(e){return e instanceof Date||typeof e==="string"&&f.test(e)}},order:{pre:function(e){var t=Date.parse(e);return isNaN(t)?-Infinity:t}}});r.type("html-num-fmt",{className:"dt-type-numeric",detect:{allOf:function(e,t){var r=t.oLanguage.sDecimal;return y(e,r,true,false)},oneOf:function(e,t){var r=t.oLanguage.sDecimal;return y(e,r,true,false)}},order:{pre:function(e,t){var r=t.oLanguage.sDecimal;return wr(e,r,u,v)}},search:or(true,true)});r.type("html-num",{className:"dt-type-numeric",detect:{allOf:function(e,t){var r=t.oLanguage.sDecimal;return y(e,r,false,true)},oneOf:function(e,t){var r=t.oLanguage.sDecimal;return y(e,r,false,false)}},order:{pre:function(e,t){var r=t.oLanguage.sDecimal;return wr(e,r,u)}},search:or(true,true)});r.type("num-fmt",{className:"dt-type-numeric",detect:{allOf:function(e,t){var r=t.oLanguage.sDecimal;return m(e,r,true,true)},oneOf:function(e,t){var r=t.oLanguage.sDecimal;return m(e,r,true,false)}},order:{pre:function(e,t){var r=t.oLanguage.sDecimal;return wr(e,r,v)}}});r.type("num",{className:"dt-type-numeric",detect:{allOf:function(e,t){var r=t.oLanguage.sDecimal;return m(e,r,false,true)},oneOf:function(e,t){var r=t.oLanguage.sDecimal;return m(e,r,false,false)}},order:{pre:function(e,t){var r=t.oLanguage.sDecimal;return wr(e,r)}}});var wr=function(e,t,r,a){if(e!==0&&(!e||e==="-"))return-Infinity;var n=typeof e;if(n==="number"||n==="bigint")return e;t&&(e=g(e,t));if(e.replace){r&&(e=e.replace(r,""));a&&(e=e.replace(a,""))}return e*1};t.extend(true,r.ext.renderer,{footer:{_:function(e,t,r){t.addClass(r.tfoot.cell)}},header:{_:function(e,r,a){r.addClass(a.thead.cell);e.oFeatures.bSort||r.addClass(a.order.none);var n=e.titleRow;var i=r.closest("thead").find("tr");var o=r.parent().index();r.attr("data-dt-order")==="disable"||r.parent().attr("data-dt-order")==="disable"||n===true&&o!==0||n===false&&o!==i.length-1||typeof n==="number"&&o!==n||t(e.nTable).on("order.dt.DT column-visibility.dt.DT",(function(t,n,i){if(e===n){var o=n.sortDetails;if(o){var l=D(o,"col");if(t.type!=="column-visibility"||l.includes(i)){var s;var u=a.order;var c=n.api.columns(r);var f=e.aoColumns[c.flatten()[0]];var d=c.orderable().includes(true);var v="";var h=c.indexes();var p=c.orderable(true).flatten();var g=e.iTabIndex;var m=n.orderHandler&&d;r.removeClass(u.isAsc+" "+u.isDesc).toggleClass(u.none,!d).toggleClass(u.canAsc,m&&p.includes("asc")).toggleClass(u.canDesc,m&&p.includes("desc"));var b=true;for(s=0;s<h.length;s++)l.includes(h[s])||(b=false);if(b){var y=c.order();r.addClass(y.includes("asc")?u.isAsc:""+y.includes("desc")?u.isDesc:"")}var w=-1;for(s=0;s<l.length;s++)if(e.aoColumns[l[s]].bVisible){w=l[s];break}if(h[0]==w){var x=o[0];var S=f.asSorting;r.attr("aria-sort",x.dir==="asc"?"ascending":"descending");v=S[x.index+1]?"Reverse":"Remove"}else r.removeAttr("aria-sort");if(d){var T=r.find(".dt-column-order");T.attr("role","button").attr("aria-label",d?f.ariaTitle+n.api.i18n("oAria.orderable"+v):f.ariaTitle);g!==-1&&T.attr("tabindex",g)}}}}}))}},layout:{_:function(e,a,n){var i=e.oClasses.layout;var o=t("<div/>").attr("id",n.id||null).addClass(n.className||i.row).appendTo(a);r.ext.renderer.layout._forLayoutRow(n,(function(e,r){if(e!=="id"&&e!=="className"){var a="";if(r.table){o.addClass(i.tableRow);a+=i.tableCell+" "}a+=e==="start"?i.start:e==="end"?i.end:i.full;t("<div/>").attr({id:r.id||null,class:r.className?r.className:i.cell+" "+a}).append(r.contents).appendTo(o)}}))},_forLayoutRow:function(e,t){var r=function(e){switch(e){case"":return 0;case"start":return 1;case"end":return 2;default:return 3}};Object.keys(e).sort((function(e,t){return r(e)-r(t)})).forEach((function(r){t(r,e[r])}))}}});r.feature={};r.feature.register=function(e,t,n){r.ext.features[e]=t;n&&a.feature.push({cFeature:n,fnInit:t})};function xr(e,t,r){r&&(e[t]=r)}r.feature.register("div",(function(e,r){var a=t("<div>")[0];if(r){xr(a,"className",r.className);xr(a,"id",r.id);xr(a,"innerHTML",r.html);xr(a,"textContent",r.text)}return a}));r.feature.register("info",(function(e,r){if(!e.oFeatures.bInfo)return null;var a=e.oLanguage,n=e.sTableId,i=t("<div/>",{class:e.oClasses.info.container});r=t.extend({callback:a.fnInfoCallback,empty:a.sInfoEmpty,postfix:a.sInfoPostFix,search:a.sInfoFiltered,text:a.sInfo},r);e.aoDrawCallback.push((function(e){Sr(e,r,i)}));if(!e._infoEl){i.attr({"aria-live":"polite",id:n+"_info",role:"status"});t(e.nTable).attr("aria-describedby",n+"_info");e._infoEl=i}return i}),"i");
/**
 * Update the information elements in the display
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function Sr(e,t,r){var a=e._iDisplayStart+1,n=e.fnDisplayEnd(),i=e.fnRecordsTotal(),o=e.fnRecordsDisplay(),l=o?t.text:t.empty;o!==i&&(l+=" "+t.search);l+=t.postfix;l=Tt(e,l);t.callback&&(l=t.callback.call(e.oInstance,e,a,n,i,o,l));r.html(l);Dt(e,null,"info",[e,r[0],l])}var Tr=0;r.feature.register("search",(function(e,a){if(!e.oFeatures.bFilter)return null;var n=e.oClasses.search;var i=e.sTableId;var o=e.oLanguage;var l=e.oPreviousSearch;var s='<input type="search" class="'+n.input+'"/>';a=t.extend({placeholder:o.sSearchPlaceholder,processing:false,text:o.sSearch},a);a.text.indexOf("_INPUT_")===-1&&(a.text+="_INPUT_");a.text=Tt(e,a.text);var u=a.text.match(/_INPUT_$/);var c=a.text.match(/^_INPUT_/);var f=a.text.replace(/_INPUT_/,"");var d="<label>"+a.text+"</label>";c?d="_INPUT_<label>"+f+"</label>":u&&(d="<label>"+f+"</label>_INPUT_");var v=t("<div>").addClass(n.container).append(d.replace(/_INPUT_/,s));v.find("label").attr("for","dt-search-"+Tr);v.find("input").attr("id","dt-search-"+Tr);Tr++;var h=function(t){var r=this.value;l.return&&t.key!=="Enter"||r!=l.search&&Ge(e,a.processing,(function(){l.search=r;Pe(e,l);e._iDisplayStart=0;be(e)}))};var p=e.searchDelay!==null?e.searchDelay:0;var g=t("input",v).val(l.search).attr("placeholder",a.placeholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",p?r.util.debounce(h,p):h).on("mouseup.DT",(function(e){setTimeout((function(){h.call(g[0],e)}),10)})).on("keypress.DT",(function(e){if(e.keyCode==13)return false})).attr("aria-controls",i);t(e.nTable).on("search.dt.DT",(function(t,r){e===r&&g[0]!==document.activeElement&&g.val(typeof l.search!=="function"?l.search:"")}));return v}),"f");r.feature.register("paging",(function(e,a){if(!e.oFeatures.bPaginate)return null;a=t.extend({buttons:r.ext.pager.numbers_length,type:e.sPaginationType,boundaryNumbers:true,firstLast:true,previousNext:true,numbers:true},a);var n=t("<div/>").addClass(e.oClasses.paging.container+(a.type?" paging_"+a.type:"")).append(t("<nav>").attr("aria-label","pagination").addClass(e.oClasses.paging.nav));var i=function(){Cr(e,n.children(),a)};e.aoDrawCallback.push(i);t(e.nTable).on("column-sizing.dt.DT",i);return n}),"p");function _r(e){var t=[];e.numbers&&t.push("numbers");if(e.previousNext){t.unshift("previous");t.push("next")}if(e.firstLast){t.unshift("first");t.push("last")}return t}function Cr(e,a,n){if(e._bInitComplete){var i=n.type?r.ext.pager[n.type]:_r,o=e.oLanguage.oAria.paginate||{},l=e._iDisplayStart,s=e._iDisplayLength,u=e.fnRecordsDisplay(),c=s===-1,f=c?0:Math.ceil(l/s),d=c?1:Math.ceil(u/s),v=[],h=[],p=i(n).map((function(e){return e==="numbers"?Ar(f,d,n.buttons,n.boundaryNumbers):e}));v=v.concat.apply(v,p);for(var g=0;g<v.length;g++){var m=v[g];var b=Ir(e,m,f,d);var y=xt(e,"pagingButton")(e,m,b.display,b.active,b.disabled);var D=typeof m==="string"?o[m]:o.number?o.number+(m+1):null;t(y.clicker).attr({"aria-controls":e.sTableId,"aria-disabled":b.disabled?"true":null,"aria-current":b.active?"page":null,"aria-label":D,"data-dt-idx":m,tabIndex:b.disabled?-1:e.iTabIndex&&y.clicker[0].nodeName.toLowerCase()!=="span"?e.iTabIndex:null});typeof m!=="number"&&t(y.clicker).addClass(m);bt(y.clicker,{action:m},(function(t){t.preventDefault();ze(e,t.data.action,true)}));h.push(y.display)}var w=xt(e,"pagingContainer")(e,h);var x=a.find(document.activeElement).data("dt-idx");a.empty().append(w);x!==void 0&&a.find("[data-dt-idx="+x+"]").trigger("focus");if(h.length){var S=t(h[0]).outerHeight();n.buttons>1&&S>0&&t(a).height()>=S*2-10&&Cr(e,a,t.extend({},n,{buttons:n.buttons-2}))}}}
/**
